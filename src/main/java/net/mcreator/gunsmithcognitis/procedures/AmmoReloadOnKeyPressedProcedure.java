...
import net.mcreator.gunsmithcognitis.PercussionFirearmReloadHandler;
...
public class AmmoReloadOnKeyPressedProcedure {
	public static void execute(Entity entity) {
		...
		if ((entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).is(ItemTags.create(new ResourceLocation("gunsmith_cognitis:firearm")))
			...
			if ((entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).is(ItemTags.create(new ResourceLocation("gunsmith_cognitis:minie_muzzleloaders")))) {
				PercussionFirearmReloadHandler.execute(entity);
			}
