...
import net.mcreator.gunsmithcognitis.procedures.HandBombWhileProjectileFlyingTickProcedure;
import net.mcreator.gunsmithcognitis.init.GunsmithCognitisModItems;
import net.mcreator.gunsmithcognitis.init.GunsmithCognitisModEntities;

@OnlyIn(value = Dist.CLIENT, _interface = ItemSupplier.class)
public class HandBombProjectileEntity extends AbstractArrow implements ItemSupplier {
	public static final ItemStack PROJECTILE_ITEM = new ItemStack(GunsmithCognitisModItems.HAND_BOMB.get());

	public HandBombProjectileEntity(PlayMessages.SpawnEntity packet, Level world) {
		super(GunsmithCognitisModEntities.HAND_BOMB_PROJECTILE.get(), world);
	}

	public HandBombProjectileEntity(EntityType<? extends HandBombProjectileEntity> type, Level world) {
		super(type, world);
	}

	public HandBombProjectileEntity(EntityType<? extends HandBombProjectileEntity> type, double x, double y, double z, Level world) {
		super(type, x, y, z, world);
	}

	public HandBombProjectileEntity(EntityType<? extends HandBombProjectileEntity> type, LivingEntity entity, Level world) {
	...
	public static HandBombProjectileEntity shoot(Level world, LivingEntity entity, RandomSource source) {
		return shoot(world, entity, source, 0.8f, 1, 1);
	}

	public static HandBombProjectileEntity shoot(Level world, LivingEntity entity, RandomSource random, float power, double damage, int knockback) {
		HandBombProjectileEntity entityarrow = new HandBombProjectileEntity(GunsmithCognitisModEntities.HAND_BOMB_PROJECTILE.get(), entity, world);
	...
	public static HandBombProjectileEntity shoot(LivingEntity entity, LivingEntity target) {
		HandBombProjectileEntity entityarrow = new HandBombProjectileEntity(GunsmithCognitisModEntities.HAND_BOMB_PROJECTILE.get(), entity, entity.level());
