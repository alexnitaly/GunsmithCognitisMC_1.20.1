...
import net.mcreator.gunsmithcognitis.world.features.StructureFeature;
import net.mcreator.gunsmithcognitis.init.GunsmithCognitisModVillagerProfessions;
import net.mcreator.gunsmithcognitis.init.GunsmithCognitisModTabs;
import net.mcreator.gunsmithcognitis.init.GunsmithCognitisModSounds;
...
public class GunsmithCognitisMod {
	...
	public GunsmithCognitisMod() {
		...
		GunsmithCognitisModSounds.REGISTRY.register(bus);
		...
		GunsmithCognitisModTabs.REGISTRY.register(bus);

		StructureFeature.REGISTRY.register(bus);

		GunsmithCognitisModVillagerProfessions.PROFESSIONS.register(bus);
		GunsmithCognitisModMenus.REGISTRY.register(bus);
