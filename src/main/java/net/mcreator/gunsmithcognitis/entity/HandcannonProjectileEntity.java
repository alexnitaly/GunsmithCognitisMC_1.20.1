...
public class HandcannonProjectileEntity extends AbstractArrow implements ItemSupplier {
	public static final ItemStack PROJECTILE_ITEM = new ItemStack(GunsmithCognitisModItems.HEAVY_MUSKET_BALL_PROJECTILE.get());

	public HandcannonProjectileEntity(PlayMessages.SpawnEntity packet, Level world) {
		super(GunsmithCognitisModEntities.HANDCANNON_PROJECTILE.get(), world);
	}
	...
	public static HandcannonProjectileEntity shoot(Level world, LivingEntity entity, RandomSource random, float power, double damage, int knockback) {
		HandcannonProjectileEntity entityarrow = new HandcannonProjectileEntity(GunsmithCognitisModEntities.HANDCANNON_PROJECTILE.get(), entity, world);
	...
	public static HandcannonProjectileEntity shoot(LivingEntity entity, LivingEntity target) {
		HandcannonProjectileEntity entityarrow = new HandcannonProjectileEntity(GunsmithCognitisModEntities.HANDCANNON_PROJECTILE.get(), entity, entity.level());
