package net.mcreator.gunsmithcognitis.world.features;
...
import net.mcreator.gunsmithcognitis.world.features.configurations.StructureFeatureConfiguration;
...
public class StructureFeature extends Feature<StructureFeatureConfiguration> {
	public static final DeferredRegister<Feature<?>> REGISTRY = DeferredRegister.create(ForgeRegistries.FEATURES, GunsmithCognitisMod.MODID);
